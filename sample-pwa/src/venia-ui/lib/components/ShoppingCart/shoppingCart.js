...
const ShoppingCart = () => {
    ...
    const cartId = storeDetails && storeDetails.cart.cartId
...
const subTotal = cartIDDetails && cartIDDetails.data.cart.prices.subtotal_excluding_tax.value
const quantity = cartIDDetails && cartIDDetails.data.cart.total_quantity
                ...
                <div style={{border:"1px solid", margin:"10px"}}>
                    ...
                    <div>Quantity: 
                        <button style={{width:"50px", height:"50px"}}
                            onClick={()=> decreaseQuantity(el.quantity)}
                        >-</button>
                            {productCount > 0 ? productCount : el.quantity }
                        <button style={{width:"50px", height:"50px"}}
                            onClick={()=> increaseQuantity(el.quantity) }
                        >+</button>
                    </div>
