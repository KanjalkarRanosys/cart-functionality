...
import { ADD_PRODUCT_TO_CART, VIEW_PRODUCT } from '../queries/queries'
...
const ViewProduct = () => {
  ...
  return (
    ...
    {addToCartLoader | loading ? <div>{fullPageLoadingIndicator}</div>:
    <>
        {data && data.products &&
                        ...
                        <div className='view-product-desc'>
                            ...
                            <div className='fashion-size'>
                                ...
                                <div className='grp-column'>
                                    <button className={quantity == 1 ? "disableQuantityUpdate" : "quantityButton"}
                                        onClick={()=>{
                            ...
                            // disabled={!isColor && true}
                                ...
                                onClick={ async ()=>{
                                    isColor ? 
                                    selectedColor && selectedSize && await addToCart() : selectedSize && await addToCart(),
                                    setSelectedColor(), setSelectedSize(), setSelectedOptions([])
                                }}
                            >Add To Cart</button>
                            </div>
                            {/* <div>
